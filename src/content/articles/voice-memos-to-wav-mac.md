...
<figure>
  <img src="/images/voice-memo-to-wav.png" alt="Converting compressed iPhone voice memos to uncompressed WAV for editing on Mac">
  <figcaption>Converting compressed voice memos to uncompressed WAV.</figcaption>
</figure>
...
Voice memos can hold sensitive interviews and private notes. Web converters need you to upload them; Converleon processes the files offline so raw recordings never leave your device — part of its [local-only approach](/blog/stop-using-online-converters).
...
Then [extract the audio track](/blog/extract-audio-from-video-mac) from the MOV or MP4 first, and export straight to WAV.

## Wrapping up

Getting audio off an iPhone and into your editor should be simple. Batch-convert your memos to WAV and they're ready for production. If you also keep a FLAC library, [converting FLAC to M4A or WAV](/blog/flac-to-m4a-wav-mac) is the same kind of job.
